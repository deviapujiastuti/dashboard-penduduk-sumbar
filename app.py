...
@st.cache_data
def load_data():
    # Pastikan file ini sudah diupload ke folder Colab atau GitHub nantinya
    file_path = 'Perkembangan Penduduk Sumatera Barat.xlsx'
    
    # Membaca excel (header disesuaikan dengan struktur file temanmu)
